<template>
    <div>
        <p>これは電灯のスイッチです。<br>電灯が光っている状態にしてください。</p>
        <div id="question-img-comp">
            <a class="switcharea" @click="switchState()">
                <img src="@/assets/QuestionImgs/q2_state_a.png" class="question-img" id="state_a">
            <img src="@/assets/QuestionImgs/q2_state_b.png" class="question-img" id="state_b">
            </a>
...
export default {
    ...
    methods: {
        ...
        putTimeandChoice() {
            ...
            this.$router.push({ path: 'q2_rs', query: obj })
