<template>
    <div>
        <p>これはWi-Fiのスイッチです。<br>Wi-FiがOFFの状態にしてください。</p>
        <div id="question-img-comp">
            <a class="switcharea" @click="switchState()">
                <img src="@/assets/QuestionImgs/q5_state_a.png" class="question-img" id="state_a">
            <img src="@/assets/QuestionImgs/q5_state_b.png" class="question-img" id="state_b">
            </a>
...
export default {
    ...
    methods: {
        ...
        putTimeandChoice() {
            ...
            this.$router.push({ path: 'q5_rs', query: obj })
